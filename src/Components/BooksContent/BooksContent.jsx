    ...
    <div className="BooksContent">
      ...
      <div>
        ...
        <div className="comment_box">
          ...
          <p className="comment">
            Inson bolasi ne kunlarni ko‘rmaydi?! <br /> Har bir odam o‘z g‘ami bilan
            bo‘lsa, hayotdan ko‘z yumib ketganlarga umr bo‘yi motam tutib o‘tsa,
            bu moddiy olam shu kunlarga yetolarmidi? <br /> Hayot to‘lqini ojizlarni
        ...
        <div className="comment_box">
          ...
          Yer kurrasida chumolidek mehnat qilayotganlardan ko‘ra, tuproq tagida <br /> yotganlar ko‘p. Yer qatlami odam suyaklariga to‘lib ketgan.
          </p>
          <div className="icon">
            <img src={like} alt="" className="like" />
            <img src={send} alt="" className="send" />
